...
const AboutUs = () => {
  ...
  const features = [
    {
      icon: Users,
      title: "Our Mission",
      description: "To revolutionize the Wheeluxe-marketplace by connecting buyers and sellers through a transparent, trustworthy, and technology-driven platform."
    },
    {
      icon: Target,
      title: "Our Vision",
  ...
  const team = [
    ...
    },
    {
      ...
      role: " Adding of Cool & Useful Functionalities",
      description: "Expert in building scalable backend systems and API development."
    },
    {
      name: "Ram Sai",
      role: "Problem Reseacher",
      description: "Specializes in gathering of information."
    },
    {
      name: "Kammani Shasank",
      role: "Admin authentication",
      description: "Passionate about dealing with databases."
    },
      {
      name: "Shaik Samreen",
      role: "WorkFlow for an problem statement",
      description: "Passionate about creating roots for solution."
      },
